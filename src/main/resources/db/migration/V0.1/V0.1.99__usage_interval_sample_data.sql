...
BEGIN
  IF NOT EXISTS (SELECT FROM usage.interval_block ib WHERE ib.uuid = '55df1aa4-c63f-5cd5-abd4-59164c448ee0') THEN
    ...
    VALUES ('55df1aa4-c63f-5cd5-abd4-59164c448ee0', NULL, '2012-03-02 05:00:00',
            'http://localhost:8080/espi/1_1/resource/RetailCustomer/9B6C7066/UsagePoint/5446AF3F/MeterReading/01' ||
            '/IntervalBlock/173',
            'self', 'http://localhost:8080/espi/1_1/resource/RetailCustomer/9B6C7066/UsagePoint/5446AF3F/MeterReading/01/IntervalBlock', 'up', '2012-03-02 05:00:00'),
      ('e6d44d83-a357-58df-b8fb-296cebf4fca0', NULL, '2012-03-03 05:00:00', 'http://localhost:8080/espi/1_1/resource/RetailCustomer/9B6C7066/UsagePoint/5446AF3F/MeterReading/01/IntervalBlock/174', 'self', 'http://localhost:8080/espi/1_1/resource/RetailCustomer/9B6C7066/UsagePoint/5446AF3F/MeterReading/01/IntervalBlock', 'up', '2012-03-03 05:00:00'),
      ('549cca03-0083-5fd5-ab90-1fbadf535fd6', NULL, '2012-03-04 05:00:00', 'http://localhost:8080/espi/1_1/resource/RetailCustomer/9B6C7066/UsagePoint/5446AF3F/MeterReading/01/IntervalBlock/175', 'self', 'http://localhost:8080/espi/1_1/resource/RetailCustomer/9B6C7066/UsagePoint/5446AF3F/MeterReading/01/IntervalBlock', 'up', '2012-03-04 05:00:00');
