...
public enum ResponseTypes {
	...
	ResponseTypes(String schemaValue) {
		this.schemaValue = schemaValue;
	}
	public static ResponseTypes getAccumulationKindFromSchemaValue(String schemaValue) {
		return EnumSet.allOf(ResponseTypes.class).stream()
